...
#Lambda equivalent to the num_greater_than function from assignment 4
l1_1=list(filter(lambda i:i>5,map(lambda i:i,l1)))
print(len(l1_1))#correct output 15
l2_1=list(filter(lambda i:i>0,map(lambda i:i,l2)))
print(len(l2_1))#correct output 143

#List comprehension equivalent of sum_of_elements_less_than function from assignment 4
print(sum(i for i in l1 if i<2)) #Correct output -26
print(sum(i for i in l2 if i<3)) #Correct output -409

#List comprehension equivalent for the biggest_even_number function from assignent 4
print(max(i for i in l1 if i % 2 == 0))#Correct output 28
print(max(i for i in l2 if i % 2 == 0))#Correct output 34
